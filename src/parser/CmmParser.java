...
public class CmmParser extends Parser {
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public List<TerminalNode> MULTI_LINE_COMMENT() { return getTokens(CmmParser.MULTI_LINE_COMMENT); }
		public TerminalNode MULTI_LINE_COMMENT(int i) {
			return getToken(CmmParser.MULTI_LINE_COMMENT, i);
		}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << WS) | (1L << ID) | (1L << INT_CONSTANT) | (1L << CHAR_CONSTANT) | (1L << REAL_CONSTANT) | (1L << MULTI_LINE_COMMENT) | (1L << SINGLE_LINE_COMMENT))) != 0)) {
				{
				{
				setState(2);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << WS) | (1L << ID) | (1L << INT_CONSTANT) | (1L << CHAR_CONSTANT) | (1L << REAL_CONSTANT) | (1L << MULTI_LINE_COMMENT) | (1L << SINGLE_LINE_COMMENT))) != 0)) ) {
